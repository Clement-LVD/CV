...
💼 Depuis Janvier 2024 : **Data-scientist (ou 'attaché confirmé', en language INSEE)** - *Ministère de la transition écologique / Service des Données et Études Statistiques (La Défense)*

- ⏩ Chef de la division 'marchés des logements neufs' & direction de l'enquête de suivi de la commercialisation des logements neufs
  -   🕵 [Automatisation de l'activité] *Réalisation de programmes en R* pour automatiser les contentieux (fév. 2024), la récupération des données (juin 2024), les publications trimestrielles (aout 2024), {..} les contrôles sur la base SQL (janv. 2025), les payes (mars 2025), etc.
  -   🤴 Gestion de l'enquête et supervision d'une équipe de 3 chefs de pôles, 12 gestionnaires et 65 enquêteurs
  -   📝 Réalisation des publications trimestrielles du CGDD sur la commercialisation des logements neufs

<div class='job'>
💼 2021 - 2023 : **Data-scientist / Ingénieur de recherches** - *Univ. Gustave Eiffel (Versailles)*

- ⏩ Analyses sur les accidents routiers (p. ex. base d'accidents recensés par la police, enquêtes et *textes* explicatifs des accidents)
...
<div class='job'>
💼 2016 - 2020 : **Chargé d'enseignements et doctorant contractuel** -  *UNÎMES*

- ⏩ Enseignements de niveaux licence à Master (psycho-sociologie, méthodes expérimentales, analyses statistiques)
- ⏩ Recherches sur les méthodes d'un bilan des communications pendant les crises (p. ex. analyses massives via l'API Facebook)
- ⏩  Restitutions en conférences et organisation d'ateliers en analyses de données ou en communication de crise
</div>

<div class='job'>
💼 2015 : **Chargé d'études (Research internship)** - *Mairie d'Igny*
...
## 🎓 Formations
- **2025** : Compilation de programmes en R & domotique KNX
- **2024 - INSEE** : Redressements statistiques (p. ex. non-réponse, secrétisation, désaisonnalisation) 
- **2022 - Stanford University**^[lien vers le certificat : https://courses.edx.org/certificates/07dd917be3654e058599574b3a1fa40e] : Bases de données relationnelles et SQL 
- **2021 - ED583 [UNÎMES & IMT Alès]** : Doctorat en psychosociologie
- **2015 - Univ. Paris V** : Psychologue social et environnemental 
-  
- **2008 à 2015** : Artisan TCE (tous corps d'état = expérimenté en montage électrique, menuiserie, maçonnerie, etc.)
</div>
